        ...
        >
          ...
          >
             ...
             <div className="flex justify-between items-center mb-6">
                <h3 className="text-3xl md:text-4xl font-black uppercase tracking-tight">Google Form 入社申請</h3>
                <button 
                  onClick={onClose} 
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4 font-bold text-lg">
                    <div className="flex flex-col gap-1">
                      ...
                      <input required type="text" className="w-full bg-gray-50 border-4 border-black p-3 focus:outline-none focus:bg-yellow-50 placeholder-gray-400 transition-colors" placeholder="e.g. B110..." />
                    </div>
                    <div className="flex flex-col gap-1">
                      <label className="uppercase font-black tracking-widest">姓名 / 筆名</label>
                      <input required type="text" className="w-full bg-gray-50 border-4 border-black p-3 focus:outline-none focus:bg-yellow-50 placeholder-gray-400 transition-colors" placeholder="王小明" />
                    </div>
                    <div className="flex flex-col gap-1">
                      <label className="uppercase font-black tracking-widest">聯絡方式 (IG / Email)</label>
                      <input required type="text" className="w-full bg-gray-50 border-4 border-black p-3 focus:outline-none focus:bg-yellow-50 placeholder-gray-400 transition-colors" placeholder="方便找到你的管道" />
                    </div>
                    <div className="flex flex-col gap-1">
                      <label className="uppercase font-black tracking-widest">入社理由及喜歡的作品</label>
                      <textarea required rows={3} className="w-full bg-gray-50 border-4 border-black p-3 focus:outline-none focus:bg-yellow-50 placeholder-gray-400 resize-none transition-colors" placeholder="大聲說出你對漫畫的愛吧！"></textarea>
                    </div>
